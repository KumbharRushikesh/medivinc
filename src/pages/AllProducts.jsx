...
const AllProducts = () => {
  ...
  const [newProduct, setNewProduct] = useState({ brand: "", description: "", division: "" });
  ...
  const handleAddProduct = () => {
    if (newProduct.brand && newProduct.description && newProduct.division) {
        ...
        <table className="w-full border-collapse border border-gray-300 text-sm">
          <thead className="bg-cyan-600 text-white">
            ...
            <tr>
              ...
              >
                Brand Name {sortConfig.key === "brand" ? (sortConfig.direction === "asc" ? "▲" : "▼") : ""}
              </th>
              <th
                className="cursor-pointer border border-gray-300 p-2"
